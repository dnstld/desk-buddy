...
import Workspacey from "@/src/components/features/auth/logo/workspacey";
import Text from "@/src/components/ui/text";
import { useRoomsQuery, useUserQuery } from "@/src/hooks";
...
export default function AppLayout() {
  ...
  // Check if user exists in database (query is cached from index.tsx)
